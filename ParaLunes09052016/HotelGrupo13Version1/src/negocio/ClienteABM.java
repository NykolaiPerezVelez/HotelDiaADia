...
public class ClienteABM {				
	...
	public int agregar(float totalGastadoEnHotel, int cantidadEstadias, String apellido, String nombre, int dni,
		...
		//Consultar si existe un cliente con el mismo dni, si existe arrojar la Excepcion:
			...
			c= new Cliente( totalGastadoEnHotel,  cantidadEstadias,  apellido,  nombre,  dni,
				 tel);
